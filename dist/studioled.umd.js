...
/* harmony export */   "StudioLed": () => (/* binding */ StudioLed)
/* harmony export */ });
 ...
 *
 */
var StudioLed = /*#__PURE__*/_createClass(function StudioLed(_ref) {
  ...
  var _sprites = {}; // Cria um elemento canvas;
  ...
  _config.value = initialValue; // Define o status do display como "default";

  _config.status = "default"; // Função responsavel por carregar as imagens;
  ...
  loadImages(); // Formata o valor a ser exibido inicialmente;
